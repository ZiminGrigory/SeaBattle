...
#include "../client/src/tcpClient/gameState.h"
...
struct qt_meta_stringdata_GameState_t {
    QByteArrayData data[7];
    char stringdata[56];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GameState_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GameState_t qt_meta_stringdata_GameState = {
    {
QT_MOC_LITERAL(0, 0, 9),
QT_MOC_LITERAL(1, 10, 5),
QT_MOC_LITERAL(2, 16, 0),
QT_MOC_LITERAL(3, 17, 4),
QT_MOC_LITERAL(4, 22, 21),
QT_MOC_LITERAL(5, 44, 4),
QT_MOC_LITERAL(6, 49, 5)
    },
    "GameState\0abort\0\0send\0Protocol::RequestType\0"
    "type\0bytes\0"
};
...
void GameState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->send((*reinterpret_cast< Protocol::RequestType(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject GameState::staticMetaObject = {
    { &ClientState::staticMetaObject, qt_meta_stringdata_GameState.data,
      qt_meta_data_GameState,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameState.stringdata))
