...
#include "../client/src/gameLogics/gameField.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GameField_t, stringdata) + ofs \
...
const QMetaObject GameField::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameField.data,
      qt_meta_data_GameField,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameField.stringdata))
