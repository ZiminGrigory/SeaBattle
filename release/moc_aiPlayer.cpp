...
#include "../client/src/gameLogics/aiPlayer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AIPlayer_t, stringdata) + ofs \
...
const QMetaObject AIPlayer::staticMetaObject = {
    { &Player::staticMetaObject, qt_meta_stringdata_AIPlayer.data,
      qt_meta_data_AIPlayer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AIPlayer.stringdata))
