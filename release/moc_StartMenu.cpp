...
#include "../client/src/view/StartMenu.h"
...
QT_MOC_LITERAL(4, 49, 16)
    ...
    "StartMenu\0buttonVsPlayerPushed\0\0"
    "buttonVsPcPushed\0buttonExitPushed\0"
};
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->buttonVsPlayerPushed(); break;
        case 1: _t->buttonVsPcPushed(); break;
        case 2: _t->buttonExitPushed(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StartMenu::buttonVsPlayerPushed)) {
                *result = 0;
            }
        }
        {
            typedef void (StartMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StartMenu::buttonVsPcPushed)) {
                *result = 1;
            }
        }
        {
            typedef void (StartMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StartMenu::buttonExitPushed)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject StartMenu::staticMetaObject = {
    { &InterfaceStartMenu::staticMetaObject, qt_meta_stringdata_StartMenu.data,
...
void *StartMenu::qt_metacast(const char *_clname)
{
    ...
    return InterfaceStartMenu::qt_metacast(_clname);
}

int StartMenu::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = InterfaceStartMenu::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
...
// SIGNAL 0
void StartMenu::buttonVsPlayerPushed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void StartMenu::buttonVsPcPushed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void StartMenu::buttonExitPushed()
{
