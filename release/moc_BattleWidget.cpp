...
#include "../client/src/view/BattleWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BattleWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 30, 7)
    ...
    "BattleWidget\0setMessage\0\0text\0decTime\0"
};
...
const QMetaObject BattleWidget::staticMetaObject = {
    { &InterfaceBattleWidget::staticMetaObject, qt_meta_stringdata_BattleWidget.data,
      qt_meta_data_BattleWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BattleWidget.stringdata))
        return static_cast<void*>(const_cast< BattleWidget*>(this));
    return InterfaceBattleWidget::qt_metacast(_clname);
}

int BattleWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = InterfaceBattleWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
