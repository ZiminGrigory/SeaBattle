...
**
** Created: Mon 2. Sep 19:08:10 2013
...
static const char qt_meta_stringdata_Ship[] = {
    "Ship\0"
};
...
const QMetaObjectExtraData Ship::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Ship::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ship,
      qt_meta_data_Ship, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Ship::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Ship))
