...
static const char qt_meta_stringdata_Field[] = {
    "Field\0\0item\0playerAttackCell(Cell*)\0"
    "x,y\0shipOnCells(int,int)\0"
    "cellWasAttacked(Cell*)\0first,second\0"
    "getCoordinate(QPointF,QPointF)\0"
};
...
void Field::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->playerAttackCell((*reinterpret_cast< Cell*(*)>(_a[1]))); break;
        case 1: _t->shipOnCells((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->cellWasAttacked((*reinterpret_cast< Cell*(*)>(_a[1]))); break;
        case 3: _t->getCoordinate((*reinterpret_cast< QPointF(*)>(_a[1])),(*reinterpret_cast< QPointF(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Field::playerAttackCell(Cell * _t1)
{
...
// SIGNAL 1
void Field::shipOnCells(int _t1, int _t2)
{
