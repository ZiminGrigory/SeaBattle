...
static const char qt_meta_stringdata_HumanPlayer[] = {
    "HumanPlayer\0\0turn()\0"
};
...
const QMetaObjectExtraData HumanPlayer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject HumanPlayer::staticMetaObject = {
    { &Player::staticMetaObject, qt_meta_stringdata_HumanPlayer,
      qt_meta_data_HumanPlayer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &HumanPlayer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HumanPlayer))
